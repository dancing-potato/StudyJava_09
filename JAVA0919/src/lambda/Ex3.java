...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *    (최종 출력되는 bytecode는 단순 반복문보다 몇단계를 더 거칠수 밖에 없다.)
		 * 
		 * 2. 디버깅 시 추적이 극도로 어렵다.
		 * 	  (거의 불가능에 가깝다 
		 ...
		 * 		-> 간단한 로직이어야 한다.)
		 * 
		 * 3. 람다식이 남용되면 오히려 코드를 이해하기 어려울 수 있다. (가독성 떨어짐)
		 * 
		 * < 최종 결론 >
		 * - 단순하고 간결한 로직이 그때그때(일회성) 사용될 경우 람다식(O)
		 * 
		...
		// 6보다 작은 값 > 짝수인것만 > 결과에 모두 10을 곱한다. > 제일 첫번째 요소 
